...
description: "Perceivable, Operable, Understandable, and Robust accessibility guidelines for PenguinMails"
...
- [Implementation](/docs/design/accessibility-guidelines/implementation) - Development process and testing
